...
//        System.out.println(Integer.toBinaryString(-5));
        ...
        java.math.BigInteger bigOriginal1 = new java.math.BigInteger("-5871");
        System.out.println(bigOriginal1.modPow(new java.math.BigInteger("650"), new java.math.BigInteger("350")));

//        System.out.println(new java.math.BigInteger("-5871").mod(new java.math.BigInteger("350")));
...
//        System.out.println(Arrays.toString(bigOriginal1.toByteArray()));
        ...
        AbstractBigInteger big1 = new math.BigIntegerBytesList("-5871");
        System.out.println(big1.modPow(new math.BigIntegerBytesList("650"), new math.BigIntegerBytesList("350")));
